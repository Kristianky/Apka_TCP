...
public:
    bool L_Btn_Clicked;  //Stav Laveho tlacidla mysi
    ...
    bool Btn_In(HWND Main_hwnd, LPARAM lparam); //Sledovanie mysi na hlokne
    void Btn_Clicked(HWND Main_hwnd, UINT umsg); //Sledovanie tlacidiel mysi
};
